...
{
    //FSWZCICVTDOTWWCT
	public static String account = "bdqnwubin@163.com";			//替换为发件人账号
    public static String password = "FSWZCICVTDOTWWCT";					//替换为发件人账号密码
    ...
    public static MimeMessage createMimeMessage(String code,Session session, String sendMail, String receiveMail)
        ...
        // 5. Content: 邮件正文
        message.setContent("用户你好，欢迎注册，注册码为8774", "text/html;charset=UTF-8");
        // 6. 设置发件时间
